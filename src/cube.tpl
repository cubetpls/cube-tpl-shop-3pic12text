<div class="wrapper"  c-hide={{tabs.length == 0}}>
   <ul class="tabs">
      ...
      <li class="item {{item_index === current ? 'current' : ''}}" on-click={{this.tabClick(item_index)}}>
        <a href="javascript:void(0);" on-click="{{this.returnFalse()}}">{{item}}</a>
      </li>
      {{/list}}
   </ul>
   <ul class="views">
         ...
         <ul class="img-list">
            ...
            <li class="img-item">
               <a href="{{img_item.link}}">
                  <img src="{{img_item.img|clipImage: '116_126_'}}" on-error="this.onerror=null; this.src='https://p4.ssl.qhimg.com/t018947d5e6d9bb174f.png'" alt="">
